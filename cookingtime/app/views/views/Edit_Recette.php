            ...
            <div class="table-forms">
                <div class="box-add">
                    ...
                    <form action="routeur.php" method="post" name="form-recette" enctype="multipart/form-data">
                        ...
                        <input type="file" name="ImgRecette" id="img" accept="images/png, image/jpeg" value="../public/img/img_recettes/recette_<?php echo $recette->getIdRecette();?>/main<?php echo $recette->getIdRecette();?>.<?php echo $recette->getExtImgRecette();?>" onchange="getTaille()">
                        <p id="fileSizeMess"></p>
